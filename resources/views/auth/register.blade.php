            ...
            <div class="p-5">
              ...
              <form class="user"  method="POST" action="/register">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input name="email" type="text" class="form-control form-control-user" id="exampleLastName" placeholder="Email">
                  </div>
                </div>
                <div class="form-group">
                  <input name="signup-key" type="password" class="form-control form-control-user" id="exampleInputEmail" placeholder="Register Key">
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
