        ...
        <section class="section-about">
            <div class="u-container">
                <div class="u-center-text">
                    <h2 class="heading-secondary u-margin-big">About Us</h2>
                    <div class="row">
                        ...
                        <div class="col-2-of-4">
                            <div class="u-padding-10 u-center-left">
                                ...
                                <p class="paragraph u-margin-medium">Based in Southend, Essex, JMS Commercial Cleaning
                                    is a reliable cleaning company that has built up a solid reputation, purely built on
                                    trust in Southend, Basildon, and surrounding areas. We pride ourselves on our
                                    reliable, consistent and friendly commercial cleaning service for our customers.
                                </p>
                                <div class="buttons">
        ...
        <section class="section-services u-color-offset">
            <div class="u-container">
                <div class="u-center-text">
                    ...
                    <p class="paragraph u-margin-big">No matter which industry you are in, you will probably find
                        yourself needing a cleaner, whether it's for a routine clean to keep your office nice and clean,
                        or just a once-off deep clean, to help brighten it up after the busy period! Whatever situation
                        you find yourself in, JMS has the solution.</p>
                            ...
                            <div class="service-circle__image">
                                <div class="image_circles__services">
                                    ...
                                    <img src="/icons/kitchen.png" alt=""
                                        class="service-circle__services--image-1">
                                    ...
                                    <img src="/icons/mopping.png" alt=""
                                        class="service-circle__services--image-3">
        ...
        <section class="section-why-choose">
            <div class="u-container u-center-text">
                ...
                <p class="paragraph u-margin-big">
                    We offer several cleaning services throughout Essex. So if you are a landlord or tenant in need or
                    an end of tenancy clean, or is your office starting to look dusty and in need of an office clean?
                    Whatever it is you might need, give us a call on 01702 667455 and we can arrange a free
                    non-obligatory quote to get your property sparkling again!</p>

                <div class="row">
                    <div class="col-1-of-2">
                        <div class="image-circle-solo">
                            <p class="paragraph image-circle-solo__text">JMS cleaners are fully trained and fully
                                equipped to deal with any job that comes their way! Our thorough vetting system allows
                                us to filter through and find the very best cleaners, with standards to match ours at
                                JMS. We also DBS check our cleaners to give you the peace of mind knowing your property
